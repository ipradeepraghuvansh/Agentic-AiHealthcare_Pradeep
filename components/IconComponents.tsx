...
export const StethoscopeIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125h-7.5A1.125 1.125 0 0 0 2.25 9.375v9A1.125 1.125 0 0 0 3.375 19.5ZM16.5 19.5h-2.25m2.25 0a1.125 1.125 0 0 0 1.125-1.125M16.5 19.5V9.375c0-.621.504-1.125 1.125-1.125h2.25A1.125 1.125 0 0 1 21.75 9.375v9a1.125 1.125 0 0 1-1.125 1.125M8.25 9.375V6.75a2.25 2.25 0 0 1 2.25-2.25h3a2.25 2.25 0 0 1 2.25 2.25v2.625M12 13.5h.008v.008H12v-.008Z" />
    </svg>
);
...
export const SkinIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
